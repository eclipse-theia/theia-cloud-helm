...
| demoApplication.name | string | `"theiacloud/theia-cloud-demo:0.10.0"` | The name of docker image to be used |
...
| landingPage.image | string | `"theiacloud/theia-cloud-landing-page:0.10.0"` | the landing page image to use |
...
| operator.image | string | `"theiacloud/theia-cloud-operator:0.10.0"` | The operator image |
...
| operator.wondershaperImage | string | `"theiacloud/theia-cloud-wondershaper:0.10.0"` | If bandwidthLimiter is set to WONDERSHAPER or K8SANNOTATIONANDWONDERSHAPER this image will be used for the wondershaper init container |
| operatorrole.name | string | `"operator-api-access"` |  |
| service | object | (see details below) | Values of the Theia.cloud REST service |
| service.image | string | `"theiacloud/theia-cloud-service:0.10.0"` | The image to use |
